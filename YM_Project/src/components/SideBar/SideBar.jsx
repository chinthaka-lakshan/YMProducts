...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 bg-gray-800 text-gray-100">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base hover:text-gray-900 text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Item List</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Purchase Stock</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Distribution Stock</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Income Analysis</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 hover:text-gray-900 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
